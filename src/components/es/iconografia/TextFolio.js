...
export const TextFolio = () => {
    return (
        <div className="text-folio-container">
            <DivFolio title="Folio 1" folio='folio1-1' text='El día 1 K’an [signo desaparecido, 1º signo de la columna
            ...
            <DivFolio title="Folio 2" folio='folio1-2' text='Segundo Texto'/ >
